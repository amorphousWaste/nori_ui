...
def get_args():
    ...
    parser.add_argument("-y", "--style",
                        help="Set a stylesheet")

    parser.add_argument("-l", "--palette",
                        help="Set a palette")

    parser.add_argument("-s", "--show_status_bar",
                        help="Show the status bar",
                        action="store_true")

    parser.add_argument("-p", "--as_popup",
                        help="Show as popup",
                        action="store_true")
...
def launch_window():
    ...
    if args['example']:
        mw = example_ui.create_example(
            default=args['default'], from_file=args['from_file'],
            style=args['style'], palette=args['palette']
        )
