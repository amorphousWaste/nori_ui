...
Etiam eu rutrum nisi, quis pretium lacus."
    ...
    def create_list_tab(self):
        ...
        for i in range(1, items + 1):
            self.list.addItem('List Item {}'.format(i))
    ...
    def create_tree_tab(self):
        ...
        for column in range(columns):
            headers.append('Header {}'.format(column + 1))

        self.tree.setHeaderLabels(headers)

        for i in range(items):
            item = QtWidgets.QTreeWidgetItem(
                ['Tree Item {}'.format(i + 1), ''])
    ...
    def create_table_tab(self):
        ...
        for r in range(rows):
            for c in range(columns):
                item = QtWidgets.QTableWidgetItem('Row {} Col {}'.format(r, c))
    ...
    def create_custom_widgets_tab(self):
...
def create_example(
    default=False, from_file=False, style='default', palette='default'
):
    ...
    if default:
        ...
        widget_file = os.path.join(
            os.path.dirname(__file__), 'widget_file.ui'
        )
